...
no date is input the CPI will be equal to 1 in the previous month.
...
You can input a year on which the CPI should be equal to 1. The year has
to be between 1988 and the current year. If no year is input the CPI
will be equal to 1 in the current year.
